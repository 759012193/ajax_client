...
export default class Register extends Component{
    ...
    getVerifyCode = ()=>{
        ...
        if(/^1(3|4|5|6|7|8|9)\d{9}$/.test(user_phone)){
            ...
            getPhoneCode(user_phone).then((result)=>{
                // console.log(result);
                message.success({
                    content: `[撩课学院] 短信验证码:  ${result.data.code} , 30分钟内有效!`,
                    duration: 5
                })
            });
    ...
    */
    onFinish = (e)=>{
        ...
        const user_phone = this.userPhoneRef.current.value;
        const phone_code = this.phoneCodeRef.current.value;
                            ...
                            <form onSubmit={this.onFinish}>
                                <ul className="user-zc">
                                    ...
                                    <li>
                                        ...
                                        <input name="user_name" id="user_name" type="text" placeholder="会员名应为小写字母(a-z)、数字(0-9)组合" className="zc-qsr" required ref={this.userNameRef}/>
                                    </li>
                                    <li>
                                        <span className="zc-hm">登录密码</span>
                                        <span className="SignFlow-accountSeperator">&nbsp;</span>
                                        <input name="user_password" id="user_password" type="password" placeholder="请输入您的密码" className="zc-qsr2" required ref={this.userPasswordRef}/>
                                    </li>
                                    <li>
                                        <span className="zc-hm">确认密码</span>
                                        <span className="SignFlow-accountSeperator">&nbsp;</span>
                                        <input type="password" name="c_password" id="c_password"  placeholder="请重复输入您的密码" className="zc-qsr2" required ref={this.userCPasswordRef}/>
                                    </li>
                                    <li>
                                        <span className="zc-hm">手机号码</span>
                                        <span className="SignFlow-accountSeperator">&nbsp;</span>
                                        <input name="user_phone" id="user_phone" type="text" placeholder="请输入手机号码" className="zc-qsr"  required ref={this.userPhoneRef}/>
                                    </li>
                                    <li>
                                        <span className="zc-hm">验 证 码</span>
                                        <span className="SignFlow-accountSeperator">&nbsp;</span>
                                        <input name="phone_code" id="phone_code" type="text"  placeholder="请输入 6 位短信验证码" className="zc-qsr2 m-code" required ref={this.phoneCodeRef}/>
                                            <span className="SignFlow-accountSeperator">&nbsp;</span>
                                            <button
                                                type="button"
                                                id="send_scode"
