...
export default class LifeJobList extends Component{
    constructor(props) {
        super(props);
                ...
                <div className="mainWrap clearfix">
                    <div className="banner_pagex">
                        <ul className="banner_box">
                            <li className="one"
                                style={{background: "url("+ focus022 +") no-repeat top center"}}>
                    ...
                    <div className="content content01y clearfix">
                        <div className="mainbox clearfix">
                            ...
                            <div className="sort_right">
                                共有<span className="lm_desc_num">{job_list_count}</span>篇文章，供您选择浏览
                            </div>
                                            ...
                                            <div className="joblife_con" key={item.id}>
                                                <Link
                                                    ...
                                                    <div className="joblife_con_pic">
                                                        <img src={config.BASE_URL + item.job_img} alt={""}/>
                                                    </div>
                                                    ...
                                                    <div className="joblife_con_other">
                                                        ...
                                                        <span className="joblife_con_other_teacher">
                                                            来自：{item.job_author}
                                                        </span>
                                                    </div>
                                                </Link>
